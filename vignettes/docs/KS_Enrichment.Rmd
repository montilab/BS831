...
We defined a simple script (in `CBMRtools`) that builds upon `ks.test`
...
tickmarks corresponding to the genes' ranks). First, source the script
..
...
set.seed(6719); ksGenescore(100,runif(10,min=1,max=100),do.plot=TRUE)
```
