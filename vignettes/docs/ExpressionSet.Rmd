...
## if BS831 not installed but cloned:
## load(file.path(Sys.getenv("BS831"),"data/HNSC_RNASeq_toy_ES.rda"))
...
head(colData(sexp)) # equivalent to pData
head(rowData(sexp)) # equivalent to fData
```
